...
<script>
   ...
   function onLoad(){
	   ...
	   <%}else if(classString.equalsIgnoreCase("I-STD")){%>
	   		$( "#tabs" ).tabs({ active: 4 });
	   	<%}else if(classString.equalsIgnoreCase("II-STD")){%>
	   		$( "#tabs" ).tabs({ active: 5 });
...
<div id="tabs">
      ...
      <br><br>
       ...
       <br><br>
            <!-- <input type= 'text' id='ptwoT' name= 'ptwoT' value='9:45 to 10:00 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='ptwoA' name = 'ptwoA'></textarea>
		<br><br>
   			<!-- <input type= 'text' id='pthreeT' name= 'pthreeT' value='10:00 to 10:20 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
    		 <textarea cols="80" rows="1" id='pthreeA' name = 'pthreeA'>Play Time / Snacks Break</textarea>
 		 <br><br>
    	...
    	<br><br>
     		 <!-- <input type= 'text' id='pfiveT' name= 'pfiveT' value='11:00 to 11:20 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
   		 	<textarea cols="80" rows="3" id='pfiveA' name = 'pfiveA'></textarea>
   		<br><br>
   			<!-- <input type= 'text' id='pSixT' name= 'pSixT' value='11:30 to 11:50 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
   			 <textarea cols="80" rows="3" id='pSixA' name = 'pSixA'></textarea>
      ...
      <br><br>
       ...
       <br><br>
           <!--  <input type= 'text' id='ntwoT' name= 'ntwoT' value='9:45 to 10:05 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='ntwoA' name = 'ntwoA'> </textarea>
		<br><br>
   			<!-- <input type= 'text' id='nthreeT' name= 'nthreeT' value='10:10 to 10:30 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
    		 <textarea cols="80" rows="1" id='nthreeA' name = 'nthreeA'>Play Time / Snacks Break</textarea>
 		 <br><br>
    	...
    	<br><br>
     		<!--  <input type= 'text' id='nfiveT' name= 'nfiveT' value='11:10 to 11:30 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
   		 	<textarea cols="80" rows="3" id='nfiveA' name = 'nfiveA'></textarea>
   		<br><br>
  ...
  <div id="tabs-3">
      ...
      <br><br>
       ...
       <br><br>
           <!--  <input type= 'text' id='LtwoT' name= 'LtwoT' value='9:45 to 10:00 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='LtwoA' name = 'LtwoA'></textarea>
		<br><br>
   		<!-- 	<input type= 'text' id='LthreeT' name= 'LthreeT' value='10:00 to 11:00 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
    		 <textarea cols="80" rows="1" id='LthreeA' name = 'LthreeA'>Play Time / Snacks Break</textarea>
 		 <br><br>
   		<!-- 	<input type= 'text' id='LfourT' name= 'LfourT' value='11:00 to 11:20 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='LfourA' name = 'LfourA'></textarea>
    	<br><br>
     		<!--  <input type= 'text' id='LfiveT' name= 'LfiveT' value='11:20 to 11:40 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
   		 	<textarea cols="80" rows="3" id='LfiveA' name = 'LfiveA'></textarea>
   		<br><br>
   		...
   		<!-- 	<input type= 'text' id='LSevenT' name= 'LSevenT' value='12:00 to 12:30 PM ' length = 75/> &nbsp;&nbsp;&nbsp; -->
   			<textarea cols="80" rows="3" id='LSevenA' name = 'LSevenA'></textarea>
   		<br><br>
     ...
     <br><br>
    		 <input type="submit" value ="Submit" onclick="javascript:onSubmit('LKG', 'datepicker2')"/>
     <hr><hr>
      ...
      <br><br>
       ...
       <br><br>
		...
		<br><br>
    		 ...
    		 <textarea cols="80" rows="1" id='UthreeA' name = 'UthreeA'>Play Time / Snacks Break </textarea>
 		 <br><br>
   			<!-- <input type= 'text' id='UfourT' name= 'UfourT' value='11:20 to 11:40 AM' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='UfourA' name = 'UfourA'></textarea>
    	<br><br>
   	 ...
   	 <br><br>
    		 <input type="submit" value ="Submit" onclick="javascript:onSubmit('UKG', 'datepicker3')"/>
     <hr><hr>
  </div>
 ...
 <!--  1-STD -->
  ...
  <div id="tabs-7">
     ...
     <br><br>
      ...
      <br><br>
   			<!-- <input type= 'text' id='SoneT' name= 'SoneT' value='Assembly' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3"  id='ToneA' name = 'ToneA'>Circle Time(Prayer , National Anthem & Rhymes with action)</textarea>
       <br><br>
         <!--    <input type= 'text' id='StwoT' name= 'StwoT' value='ENGLISH' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='TtwoA' name = 'TtwoA'></textarea>
		<br><br>
   			<!-- <input type= 'text' id='SthreeT' name= 'SthreeT' value='KANNADA' length = 75/> &nbsp;&nbsp;&nbsp; -->
    		 <textarea cols="80" rows="3" id='TthreeA' name = 'TthreeA'></textarea>
 		 <br><br>
   			<!-- <input type= 'text' id='SfourT' name= 'SfourT' value='HINDI' length = 75/> &nbsp;&nbsp;&nbsp; -->
     		<textarea cols="80" rows="3" id='TfourA' name = 'TfourA'></textarea>
     	<br><br>
   			<!-- <input type= 'text' id='SfiveT' name= 'SfiveT' value='MATH' length = 75/> &nbsp;&nbsp;&nbsp; -->
   		 	<textarea cols="80" rows="3" id='TfiveA' name = 'TfiveA'></textarea>
   		<br><br>
   			<!-- <input type= 'text' id='SSixT' name= 'SSixT' value='General Awareness' length = 75/> &nbsp;&nbsp;&nbsp; -->
   			 <textarea cols="80" rows="3" id=TSixA' name = 'TSixA'></textarea>
   		<br><br>
   			<!-- <input type= 'text' id='SSevenT' name= 'SSevenT' value='EVS' length = 75/> &nbsp;&nbsp;&nbsp; -->
